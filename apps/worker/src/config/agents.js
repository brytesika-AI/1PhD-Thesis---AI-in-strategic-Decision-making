const rawAgentRegistry = {
  agents: {
    tracker: {
      ...
      allowed_tools: ["gather_evidence", "run_pestle_analysis", "run_porters_five_forces"],
    ...
    auditor: {
      ...
      allowed_tools: ["root_cause_analysis", "run_value_chain_analysis"],
    ...
    innovator: {
      ...
      allowed_tools: ["generate_options", "run_scenario_planning"],
    ...
    challenger: {
      ...
      allowed_tools: ["generate_objections", "run_swot_analysis"],
    ...
    architect: {
      ...
      allowed_tools: ["build_implementation_plan", "run_value_chain_analysis"],
    ...
    guardian: {
      ...
      allowed_tools: ["generate_monitoring_rules", "run_scenario_planning"],
    ...
    decision_governor: {
      ...
      allowed_tools: ["extract_memory", "reflect_on_decision", "extract_learning", "generate_scenarios", "evaluate_outcome"],
