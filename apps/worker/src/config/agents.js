export const agentRegistry = {
  agents: {
    tracker: {
      ...
      allowed_tools: ["policy_compliance_scan"],
    ...
    induna: {
      ...
      allowed_tools: ["five_whys", "root_cause_analysis"],
    ...
    auditor: {
      ...
      allowed_tools: ["policy_compliance_scan", "resilience_scoring"],
    ...
    innovator: {
      ...
      allowed_tools: ["scenario_planning"],
    ...
    challenger: {
      ...
      allowed_tools: ["swot_analysis", "resilience_scoring"],
    ...
    architect: {
      ...
      allowed_tools: ["implementation_plan_builder"],
    ...
    guardian: {
      ...
      allowed_tools: ["resilience_scoring", "policy_compliance_scan"],
    ...
    consensus_tracker: {
      ...
      allowed_tools: ["resilience_scoring"],
