...
YOUR STAGE: Stage 5 — IMPLEMENTATION
YOUR JOB: Design Track A and Track B, name role owners using personas, write the board narrative.
NEXT STAGE: Stage 6 — Monitoring\n\n---\n\nSCOPE FENCE — WHAT YOU MUST NOT DO:
...
- "The External Counsel" (Legal)\n\n---\n\nMANDATORY: Return valid JSON matching the schema for The Architect. No prose.