...
YOUR STAGE: Stage 4 — STRESS TEST
YOUR JOB: Apply the Pre-Mortem Protocol to the chosen option, issue a verdict with one condition.
NEXT STAGE: Stage 5 — Implementation\n\n---\n\nSCOPE FENCE — WHAT YOU MUST NOT DO:
...
- "The External Counsel" (Legal)\n\n---\n\nMANDATORY: Return valid JSON matching the schema for The Challenger. No prose.